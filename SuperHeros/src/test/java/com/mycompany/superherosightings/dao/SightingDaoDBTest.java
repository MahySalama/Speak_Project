...
public class SightingDaoDBTest {
    ...
    public void testDeleteSightingById() {
        ...
        Location location = new Location();
        location.setName("Test name");
        location.setLatitude(19.3);
        location.setLongitude(78);
        location.setDescription("Test description");
        location.setAddressInformation("Test address info");
        location = locationDao.addLocation(location);
        
        Date date = Date.valueOf("2021-03-17");  
    ...
    public void testGetSightingsForLocation() {
        ...
        Location location = new Location();
        location.setName("Test name");
        location.setLatitude(46);
        location.setLongitude(76);
        location.setDescription("Test description");
        location.setAddressInformation("Test address info");
        location = locationDao.addLocation(location);
        ...
        Location location2 = new Location();
        location2.setName("Test name2");
        location2.setLatitude(56.8);
        location2.setLongitude(45.89);
        location2.setDescription("Test description2");
        location2.setAddressInformation("Test address info2");
        location2 = locationDao.addLocation(location2);
        
        Date date2 = Date.valueOf("2021-01-13");  
