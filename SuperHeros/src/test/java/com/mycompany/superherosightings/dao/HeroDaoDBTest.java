...
public class HeroDaoDBTest {
    ...
    public void testGetAllHeros() {
        ...
        location.setLongitude(26.7);
        location.setDescription("Test description");
        location.setAddressInformation("Test address info");
        location = locationDao.addLocation(location);
        
        Date date = Date.valueOf("2020-09-21");  
    ...
    public void testUpdateHero() {
        ...
        Date date = Date.valueOf("2018-04-16");  
        ...
        Date date2 = Date.valueOf("2019-04-13");
    ...
    public void testGetHeroForSighting() {
        ...
        Date date = Date.valueOf("2021-01-13");  
        ...
        Date date2 = Date.valueOf("2020-03-24");  
    ...
    public void testGetHeroForLocation() {
        ...
        Location location = new Location();
        location.setName("Test name");
        location.setLatitude(19.76);
        location.setLongitude(-24.36);
        location.setDescription("Test description");
        location.setAddressInformation("Test address info");
        location = locationDao.addLocation(location);
        ...
        Date date2 = Date.valueOf("2020-03-17");  
